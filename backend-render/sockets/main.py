...
if WEBSOCKET_MANAGER == "redis":
    ...
    sio = socketio.AsyncServer(
        cors_allowed_origins=["http://localhost:6969", "http://127.0.0.1:6969", "http://localhost:6970", "http://127.0.0.1:6970", "http://localhost:6971", "http://127.0.0.1:6971", "http://localhost:6972", "http://127.0.0.1:6972"],
        async_mode="asgi",
...
async def connect(sid, environ, auth):
    ...
    # Allow unauthenticated connections (e.g., for signin page)
    # This prevents 403 Forbidden errors on initial page load
    return True
